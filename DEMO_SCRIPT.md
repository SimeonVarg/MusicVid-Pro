...
| 45–55s | Add a **Text** track, type a title, pick the **Bold Box** style — it appears live on the preview. | "Titles too — style presets, and they bake straight into the export." |
| 55–60s | Click **Export** → pick **TikTok** → **Export**. Let the progress bar run while you talk. | "And it encodes real H.264 in the browser — FFmpeg WASM, fully offline. On stage wifi this still works, because there's nothing to download." |
