...
export const SURFACE_TABLE: Record<string, SurfaceVerdict> = {
  ...
  'piano-bright':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'piano-electric-grand': { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'piano-honkytonk':     { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'rhodes':              { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'wurlitzer':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'harpsichord':         { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'clavinet':            { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'celesta':             { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'organ-drawbar':       { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'organ-church':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'organ-reed':          { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'accordion':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'harmonica':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-nylon':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-steel':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-electric-clean': { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-electric-jazz': { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-electric-muted': { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-overdriven':   { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'guitar-distortion':   { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'bass-upright':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'bass-pick':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'bass-fretless':       { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'bass-slap':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'viola':               { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'strings-ensemble':    { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'strings-pizzicato':   { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'strings-tremolo':     { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'sax-soprano':         { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'sax-tenor':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'sax-baritone':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'oboe':                { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'english-horn':        { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'piccolo':             { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'recorder':            { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'pan-flute':           { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'shakuhachi':          { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'ocarina':             { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'trumpet-muted':       { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'brass-section':       { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'choir-aahs':          { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'choir-oohs':          { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'sitar':               { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'banjo':               { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'koto':                { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'shamisen':            { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'kalimba':             { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
  'bagpipe':             { treatment: 'plate', reason: 'drawn silhouette - no flat playing surface to crop' },
